...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        # 初始化界面
        super().__init__()
        self.setWindowTitle('基于Unet的医学影像分割')
        ...
        # 加载模型参数
        net.load_state_dict(torch.load('best_model1.pth', map_location=device))  # todo 模型位置
        # 测试模式
        net.eval()
        self.model = net
        self.initUI()
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        about_title = QLabel('欢迎使用医学影像分割及诊断系统')  # todo 修改欢迎词语
