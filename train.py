...
def train_net(net, device, data_path, epochs=140, batch_size=4, lr=0.00001):
    # 加载训练集
...
if __name__ == "__main__":
    ...
    # 指定训练集地址，开始训练
    data_path = "./images/data" # todo 修改为你本地的数据集位置
    print("进度条出现卡着不动不是程序问题，是他正在计算，请耐心等待")
    train_net(net, device, data_path, epochs=140, batch_size=4)
